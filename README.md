...
![The gallery home page](docs/media/home.png)
...
- **[Vite](https://vitejs.dev/)** + **[React 18](https://react.dev/)** + **TypeScript** — fast dev server, typed all the way down.
- **[Tailwind CSS](https://tailwindcss.com/)** + **[shadcn/ui](https://ui.shadcn.com/)** (Radix primitives) — the design system doing the heavy lifting.
- **[Framer Motion](https://www.framer.com/motion/)** — the smooth fade-and-rise animations.
- **[Embla Carousel](https://www.embla-carousel.com/)** — the swipeable artwork rows.
- **[React Router](https://reactrouter.com/)** + **[Axios](https://axios-http.com/)** + **[TanStack Query](https://tanstack.com/query)** — routing and data plumbing.
